...
if __name__ == '__main__':
    try:
        ...
        test_dataset = datasets.MNIST(data_dir, train=False, transform=transforms.Compose([transforms.ToTensor(), transforms.Normalize((0.1307,), (0.3081,))]))
        ...
        optimizer = hvd.DistributedOptimizer(optimizer, named_parameters=model.named_parameters(), compression=compression, op=hvd.Average, gradient_predivide_factor=args.gradient_predivide_factor)
